...
Een volledige download duurt ongeveer 45-60 minuten. Voer het script opnieuw uit om nieuwe edities op te halen.
...
| `PAGE_WIDTH` | Renderbreedte in pixels | `2400` |
...
De standaard renderbreedte van 2400px (~288 DPI voor A4) geeft scherpe, goed leesbare tekst. Verlaag `PAGE_WIDTH` in `.env` naar bijv. `1200` voor kleinere bestanden (~45 MB per stuk), of verhoog naar `3600` voor maximale scherpte.

| PAGE_WIDTH | DPI (A4) | Bestandsgrootte | Geschikt voor |
|---|---|---|---|
| `1200` | ~144 | ~45 MB | Tablets, telefoons |
| `2400` | ~288 | ~110 MB | E-readers, printen |
| `3600` | ~432 | ~180 MB | Maximale scherpte |
...
- [elektormagazine-dl](https://github.com/GraafG/elektormagazine-dl) — Elektor Magazine edities als PDF
